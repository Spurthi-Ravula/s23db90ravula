...
router.get('/detail', secured, vechicle_controlers.vechicle_view_one_Page);

/* GET create vechicle page */
router.get('/create', secured, vechicle_controlers.vechicle_create_Page);

/* GET create update page */
router.get('/update', secured, vechicle_controlers.vechicle_update_Page);

/* GET delete vechicle page */
router.get('/delete', secured, vechicle_controlers.vechicle_delete_Page);
